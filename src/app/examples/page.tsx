...
const codeExamples = [
  {
    ...
    description: 'Basic test generated by Arten AI to verify page elements are visible.',
    category: 'basic',
    difficulty: 'Beginner',
...
test.describe('Wakiti Landing Page Contact Form Test', () => {
  ...
  },
  {
    ...
    description: 'Test for the Arten examples application with form interactions.',
...
test.describe('Arten Examples App Test', () => {
  test('Basic test for the Arten Examples application', async ({ page }) => {
      ...
      <div className="container relative mx-auto px-4 py-16 max-w-7xl">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Explore real-world test examples generated by Arten's AI. Each example shows the JSON test specification input and the generated Playwright test code - copy, paste, and adapt these patterns for your own testing needs.
          </p>
        </motion.div>
